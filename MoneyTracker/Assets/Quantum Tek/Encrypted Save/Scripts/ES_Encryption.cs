...
namespace QuantumTek.EncryptedSave
{
    ...
    public static class ES_Encryption
    {
        ...
        private static readonly string keyString = "116 166 203 84 126 24 203 178 23 128 64 225 47 167 170 109 117 106 135 129 0 87 109 67 207 234 211 34 184 11 156 95";
